...
define(function () {
    ...
    var DeleteController = function ($scope, $state, DeleteQueries, notification, params, view, entry) {
        this.$scope = $scope;
        this.$state = $state;
    ...
    DeleteController.$inject = ['$scope', '$state', 'DeleteQueries', 'notification', 'params', 'view', 'entry'];
