...
define(function () {
    ...
    var DeleteController = function ($scope, $state, $stateParams, DeleteQueries, notification, params, view, entry) {
        this.$scope = $scope;
        this.$state = $state;
    ...
    DeleteController.$inject = ['$scope', '$state', '$stateParams', 'DeleteQueries', 'notification', 'params', 'view', 'entry'];
