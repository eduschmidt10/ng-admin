...
CrudModule.service('RetrieveQueries', require('./repository/RetrieveQueries'));
CrudModule.service('CreateQueries', require('./repository/CreateQueries'));
CrudModule.service('UpdateQueries', require('./repository/UpdateQueries'));
CrudModule.service('DeleteQueries', require('./repository/DeleteQueries'));
...
CrudModule.config(require('./config/datePicker'));
